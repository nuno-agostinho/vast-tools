...
## Available software
- [vast-tools](https://github.com/vastgroup/vast-tools) 2.5.1 (run using the `vast-tools` command)
- Bowtie 1.3.0
- [R 4.0.3](https://r-project.org) (and multiple CRAN packages, including `ggplot2`)
